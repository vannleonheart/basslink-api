...
func (s *Service) getAdminUsers() (*[]basslink.Administrator, error) {
...
func (s *Service) getAdminUser(userId string) (*basslink.Administrator, error) {
...
func (s *Service) updateAdminUser(userId string, req *UpdateUserRequest) error {
...
func (s *Service) deleteAdminUser(userId string) error {
	var selectedUser basslink.Administrator
...
func (s *Service) createAdminUser(req *CreateUserRequest) error {
	var existingUsers []basslink.Administrator
...
func (s *Service) toggleAdminUserEnable(userId string) error {
	var selectedUser basslink.Administrator
